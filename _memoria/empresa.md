...
Resumo do projeto (na fala do próprio criador):

> "SARmoney — ferramenta interna de gestão financeira familiar. Não é
> produto público — só a família do criador usa. Divide e organiza
> despesas mensais (aluguel/condomínio do apartamento, cartão e Pix),
> com rateio por porcentagem entre os membros."
