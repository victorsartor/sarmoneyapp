...
This file is the summary. Read the matching file in `resources/` before writing
code for that area — they carry the full patterns and worked examples.

| File | Read when |
| ---- | --------- |
| `resources/component-patterns.md` | Building or refactoring a component |
| `resources/data-fetching.md` | Any query, mutation, or API layer work |
| `resources/loading-and-error-states.md` | Suspense boundaries, error boundaries, feedback |
| `resources/routing-guide.md` | Adding or changing routes (TanStack Router) |
| `resources/styling-guide.md` | MUI v7 styling, theme, Grid, `sx` vs `.styles.ts` |
| `resources/typescript-standards.md` | Typing props, responses, generics, utility types |
| `resources/file-organization.md` | Creating a feature or deciding where a file goes |
| `resources/performance.md` | Memoization, bundle size, re-render issues |
| `resources/common-patterns.md` | Forms, auth, DataGrid, dialogs |
| `resources/complete-examples.md` | Full end-to-end feature reference |
